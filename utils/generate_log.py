...
summary = ["今天工作进行得很顺利,大家都很喜欢我的嘟嘟!", "总之今天过得超棒,我发的每一条嘟嘟都收到了好多人点喜欢!", "今天超级开心呀!每隔一个小时我都在Mastodon上发了超级可爱的狗狗照片或者视频!", "总之今天我超棒,我发的嘟嘟收到了好多人点喜欢!",
...
firstRecordInTheDay = ["成功发送啦!", "这次发送很顺利的哦!", "耶,这次发送非常成功!", "这次发送很顺利哦!", "成功啦,大家都夸我发的狗狗好可爱!",
                       "发送顺利,收到了好多点喜欢!", "成功啦,有人转发了我的嘟嘟!", "哇,这次发送超级顺利!", "嘿嘿,这次发送很棒!", "成功啦,我的嘟嘟好受欢迎呢!", "太棒了,这次发送很顺利!", "成功啦,收获了好多喜欢!", "成功发送了一条可爱小狗的动态!"]
