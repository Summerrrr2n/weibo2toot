...
summary = ["哈哈今天工作进行得很顺利，大家都很喜欢我的嘟嘟！", "总之今天过得超棒，我发的每一条嘟嘟都收到了好多人的喜欢！", "今天超级开心呀！每隔一个小时我都在Mastodon上发了超级可爱的狗狗照片或者视频！", "总之今天我超棒，我发的嘟嘟收到了好多人的喜欢！",
...
failedRecord = ["啊呀，这次发送没有成功。", "唉呀，这次发送失败了。",
                "嘟嘟没有发出去！", "糟糕，这次发送失败了。", "出了点问题，发送失败了。"]
